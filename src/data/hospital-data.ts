...
export const doctors: Doctor[] = [
  {
    id: '1',
    name: { en: 'Dr. Essam Alayoubi', ar: 'د. عصام الأيوبي' },
    photo: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&w=600&q=80',
    specialty: { en: 'Emergency Medicine', ar: 'طب الطوارئ' },
    qualification: { en: 'Head of Department, Senior Specialist of Emergency Medicine', ar: 'رئيس القسم، أخصائي أول طب الطوارئ' },
    experience: 15,
  ...
  {
    id: '2',
    name: { en: 'Dr. Zainab H. Dashti', ar: 'د. زينب دشتي' },
    photo: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&w=600&q=80',
    specialty: { en: 'Clinical Nutrition', ar: 'التغذية العلاجية' },
    qualification: { en: 'Clinical Dietitian, Senior Specialist', ar: 'أخصائية أولى تغذية علاجية' },
    experience: 12,
    languages: ['English', 'Arabic'],
    gender: 'female',
    available: true,
  ...
  {
    id: '3',
    name: { en: 'Dr. Ahmad Al Fadhli', ar: 'د. أحمد الفضلي' },
    ...
    qualification: { en: 'Head of Department, Consultant of Interventional Cardiology', ar: 'رئيس القسم، استشاري أمراض القلب التداخلية' },
    experience: 20,
    languages: ['English', 'Arabic'],
    gender: 'male',
    available: true,
  ...
  {
    id: '4',
    name: { en: 'Prof. Dr. Mousa Khoursheed', ar: 'أ.د. موسى خورشيد' },
    photo: 'https://images.unsplash.com/photo-1537368910025-700350fe46c7?auto=format&fit=crop&w=600&q=80',
    specialty: { en: 'General Surgery', ar: 'الجراحة العامة' },
    qualification: { en: 'Head of Department, Consultant of General Surgery', ar: 'رئيس القسم، استشاري الجراحة العامة' },
    experience: 30,
    languages: ['English', 'Arabic'],
    gender: 'male',
    available: true,
